...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix=".klb_gui_test_", dir=repo) as temp_dir:
        ...
        assert filecmp.cmp(lux_source, restored[0], shallow=False)
        ...
        assert (batch_output / klb.EXACT_LUXENDO_ARCHIVE).exists()
        ...
        assert filecmp.cmp(batch_lux, restored_files[0], shallow=False)
