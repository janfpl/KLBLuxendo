...
class KlbLuxendoApp(tk.Tk):
    ...
    def _build_luxendo_tab(self) -> None:
        ...
        self.lux_block_x = IntVar(value=96)
        self.lux_block_y = IntVar(value=96)
        self.lux_block_z = IntVar(value=8)
    ...
    def _build_folder_tab(self) -> None:
        ...
        self.folder_block_x = IntVar(value=96)
        self.folder_block_y = IntVar(value=96)
        self.folder_block_z = IntVar(value=8)
